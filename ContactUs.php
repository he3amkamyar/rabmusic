...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="container-fluid">
            <h1 style="padding: 10px;" class="bg-info text-success">راب موزیک | تماس با ما</h1>
            <p style="padding: 10px;" class="bg-info text-success">
                برای تماس با مدیریت رسانه راب موزیک از راه های زیر اقدام کنید :
                <br />
                Phone : 09913656693
                <br />
                E-Mail : info@rabmusic.ir
            </p>
        </div>
    </div>
