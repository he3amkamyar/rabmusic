...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="panel panel-default col-sm-6">
            ...
            <div class="panel-body">
                <h4 class="alert alert-warning text-center">افزودن خواننده</h4>
                <div class="row col-sm-12">
                    <form style="margin: 10px;padding: 10px;" class="table-bordered" action="add-singer.php" method="post">
                        <h3 style="padding: 10px;" class="bg-primary text-primary text-center">افزودن خواننده</h3>
                        <div class="form-group">
                            <label for="sname"> نام خواننده <input class="form-control"  type="text" name="sname"></label>
                        </div>
                        <div class="form-group">
                    ...
                    if(isset($_POST['sub1']))
                    {
                        ...
                        $sql = "INSERT INTO singers(sid,sname) VALUES(NULL ,'$sname')";
                        $query = mysqli_query($conn,$sql);
                        if(!$query){die("Insert to '$db' Success");}
                    }
                    ?>
                </div>
            </div>
