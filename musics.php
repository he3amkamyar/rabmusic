...
<head>
    ...
    <title>
        <?php
            if(!isset($_GET['name']))
            {
                echo "راب موزیک | دانلود اهنگ ،اهنگ شاد،اهنگ خارجی،اهنگ عروسی،اهنگ ایرانی،دانلود اهنگ شاد";
            }
            else
            {
                echo " دانلود آهنگ ".$_GET['name'];
            }
        ?>
    </title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="panel-heading">
                    ...
                    <div class="list-group">
                        ...
                        <a href="index.php?singer=<?php echo $row['msinger'];?>" class="list-group-item">
                            <span class="badge"><?php echo $new_row[0];endwhile;?></span><?php echo $row['msinger'];?></a>
                        <?php endwhile;?>
                    </div>
                </div>
            </div>
            <div class="panel panel-default col-sm-6">
                ...
                {
                    $sql = "SELECT * FROM music WHERE mname = '$musicname'";
                }
                else
                {
